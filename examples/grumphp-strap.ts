...
export default (util: StrapUtils): Strap => ({
    ...
    tasks: [
        ...
        },
        {
            ...
            enabled: (ctx: Record<string, boolean>) => Boolean(ctx.pint),
        ...
        },
        {
            ...
            enabled: (ctx: Record<string, boolean>) => Boolean(ctx.normalize),
        ...
        },
        {
            ...
            skip: (ctx: Record<string, boolean>) => (ctx.configExists ? 'grumphp.yml already exists' : false),
